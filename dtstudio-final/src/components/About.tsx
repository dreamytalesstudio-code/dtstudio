...
export default function About({ about }: AboutProps) {
  ...
  return (
    <section 
      ref={sectionRef}
      id="story" 
      className="w-full bg-white py-14 md:py-20 overflow-hidden select-none relative"
    >
      <style>{`
      ...
      <div className="w-full max-w-[1100px] mx-auto px-6 md:px-8">
        <div className="mt-16 md:mt-24 flex flex-col md:flex-row items-start justify-between gap-8 border-t border-zinc-150 pt-12">
          ...
          <div className="flex-1">
            ...
            <SlowRevealParagraph 
              className="mt-6 text-zinc-600 max-w-xl text-sm md:text-base leading-relaxed font-light font-sans"
              delay={0.4}
            >
