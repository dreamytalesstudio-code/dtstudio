  ...
  return (
    <section className="relative h-screen w-full overflow-hidden bg-white">
      ...
      <div className="relative z-20 h-full w-full flex flex-col items-center justify-center text-center px-6">
        ...
        >
          {/* Main Headline */}
          <h1 className="font-serif text-3xl sm:text-5xl md:text-6xl lg:text-[4.75rem] text-luxury-black tracking-widest font-normal uppercase select-none leading-none drop-shadow-sm">
          ...
          {/* Subtitle */}
          <SlowRevealParagraph className="font-serif text-base md:text-lg lg:text-xl text-zinc-700 italic tracking-wide max-w-xl mx-auto font-light leading-relaxed mb-8" delay={0.4}>
            "{subHeadline}"
          </SlowRevealParagraph>
