...
export default function Stats({ stats }: StatsProps) {
  ...
  return (
    <section 
      ref={sectionRef}
      id="experience" 
      className="relative py-14 md:py-20 bg-white overflow-hidden border-b border-zinc-200/50"
    >
      <div className="max-w-5xl mx-auto px-6 md:px-12 relative z-10">
        ...
        <div className="max-w-3xl mx-auto mb-10 md:mb-14 text-center">
          ...
          <h2 className="font-serif text-2xl sm:text-3xl md:text-4xl text-luxury-black tracking-tight font-light leading-tight">
            The milestones of <span className="italic font-light text-zinc-800">storytelling</span>
          </h2>
          
          <SlowRevealParagraph className="max-w-2xl mx-auto text-zinc-500 font-sans text-sm sm:text-base font-light leading-relaxed mt-6" delay={0.25}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8 max-w-5xl mx-auto">
          {milestones.map((mil, idx) => (
            ...
            >
              ...
              {/* White Numerals */}
              <div className="font-serif text-4xl sm:text-5xl md:text-6xl text-white font-light tracking-tight select-none flex items-baseline">
                <Counter value={mil.value} />
                <span className="text-white text-2xl md:text-3xl font-light ml-0.5">+</span>
              </div>
              ...
              {/* Muted description */}
              <SlowRevealParagraph className="text-zinc-400 font-sans text-xs font-light tracking-wide max-w-[200px] mx-auto" delay={0.35}>
                {mil.sub}
              </SlowRevealParagraph>
            </div>
          ))}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 max-w-5xl mx-auto mt-16 md:mt-20 items-center">
          ...
          <div className="lg:col-span-6 space-y-6">
            <h3 className="font-serif text-2xl sm:text-3xl text-luxury-black font-light leading-tight tracking-tight uppercase">
              More than moments,<br />we create <span className="italic lowercase tracking-normal font-normal">memories.</span>
            </h3>
            <SlowRevealParagraph className="text-zinc-600 font-sans text-sm sm:text-base font-light leading-relaxed" delay={0.2}>
        ...
        <div className="bg-zinc-50 border border-zinc-200/60 rounded-[28px] p-6 md:p-8 max-w-4xl mx-auto mt-16 md:mt-20">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-10">
            {valueProps.map((prop, index) => (
              <div key={index} className="flex flex-col items-center text-center space-y-4">
                ...
                <SlowRevealParagraph className="text-zinc-500 font-sans text-xs font-light leading-relaxed max-w-[210px]" delay={0.25 + index * 0.1}>
                  {prop.desc}
                </SlowRevealParagraph>
              </div>
            ))}
        ...
        <div className="max-w-4xl mx-auto mt-16 md:mt-20 relative rounded-[32px] overflow-hidden group border border-zinc-200/80 shadow-xl">
          ...
          <div className="relative z-20 py-12 px-6 sm:px-8 md:px-10 flex flex-col md:flex-row md:items-center justify-between gap-6 md:gap-8">
            <div className="max-w-xl">
              ...
              <h4 className="font-serif text-xl sm:text-2xl md:text-3xl text-white font-light tracking-wide leading-tight">
                We don't just take photos,<br className="hidden sm:inline" /> we preserve your <span className="italic text-zinc-200">legacy</span>.
              </h4>
              <SlowRevealParagraph className="text-zinc-400 font-sans text-xs sm:text-sm font-light leading-relaxed mt-4" delay={0.35}>
