...
export default function Contact({ details, isModalOpen: controlledModalOpen, setIsModalOpen: setControlledModalOpen, onlyModal = false }: ContactProps) {
  ...
  return (
    <section id="contact" className="relative py-14 md:py-20 bg-white text-luxury-black overflow-hidden border-t border-zinc-200/50">
      ...
      <div className="max-w-5xl mx-auto px-6 md:px-12 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center mb-10 md:mb-14">
          <div className="lg:col-span-7 space-y-6">
            ...
            <h2 className="font-serif text-2xl sm:text-3.5xl md:text-4xl text-luxury-black tracking-wide font-bold leading-tight">
            ...
            <SlowRevealParagraph className="text-black font-sans text-xs sm:text-sm font-bold leading-relaxed max-w-xl" delay={0.25}>
        ...
        <motion.div
          ...
          className="max-w-4xl mx-auto rounded-2xl border border-zinc-200 bg-white p-5 md:p-6 flex flex-col md:flex-row justify-between items-center gap-6 shadow-sm"
        >
          <div className="flex items-center space-x-4">
            ...
            <div>
              <SlowRevealParagraph className="text-black font-serif text-sm font-bold" delay={0.15}>
                Your story deserves to be told like a masterpiece.
              </SlowRevealParagraph>
              <SlowRevealParagraph className="text-zinc-900 font-sans text-xs font-bold mt-0.5" delay={0.3}>
