      ...
      {currentPage === "gallery" ? (
        ...
        >
          ...
          <main className="relative overflow-visible bg-[#0B0B0B] pb-[4vh]">
            {/* Section 1: Home (Hero) */}
            <div id="home" className="snap-section w-full h-screen relative z-10">
                  ...
                  <div className="grid grid-cols-2 gap-x-16 gap-y-6 sm:gap-x-32 sm:gap-y-8 mb-24 max-w-lg w-full text-center">
                    ...
                    <div className="flex flex-col space-y-5 text-right">
                      ...
                      <button
                        ...
                        className="font-sans text-[11px] sm:text-xs tracking-[0.35em] font-normal uppercase text-zinc-300 hover:text-white hover:tracking-[0.4em] transition-all duration-300 text-right bg-transparent border-none cursor-pointer focus:outline-none"
                      >
                        GALLERY
                      </button>
                    </div>
