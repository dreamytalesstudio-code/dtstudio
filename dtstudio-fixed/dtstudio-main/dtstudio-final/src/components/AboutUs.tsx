...
export default function AboutUs({ about, details }: AboutUsProps) {
  ...
  return (
    <section id="about-us" className="relative py-14 md:py-20 bg-white overflow-hidden border-b border-zinc-200/40">
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-24 items-center">
          ...
          <div className="lg:col-span-5 relative flex justify-center w-full">
            ...
            <div className="relative w-full aspect-[2/3] max-h-[480px] lg:max-h-[520px] overflow-hidden rounded-[32px] bg-zinc-100 shadow-[0_24px_50px_rgba(0,0,0,0.08)] border border-black/5 z-10 group">
              <img
                src={photoUrl}
                alt={name}
          ...
          <div className="lg:col-span-7 space-y-10">
            ...
            <h2 className="font-serif text-2xl sm:text-3xl md:text-3.5xl lg:text-4xl text-[#1A1A1A] tracking-wide leading-tight font-light uppercase">
              About the <br />
            ...
            <div className="space-y-6">
              <SlowRevealParagraph className="text-luxury-black font-sans text-sm sm:text-base md:text-lg font-light tracking-wide leading-relaxed" delay={0.1}>
              ...
              <SlowRevealParagraph className="text-zinc-500 font-sans text-xs sm:text-sm font-light leading-relaxed whitespace-pre-line" delay={0.25}>
              ...
              <SlowRevealParagraph className="text-zinc-400 font-sans text-xs sm:text-sm font-light leading-relaxed" delay={0.4}>
